...
cmake "$REPO_ROOT" -DUSE_QT6=yes -DCMAKE_INSTALL_PREFIX="$BUILD_DIR/AppDir/usr" -DImageMagick_INCLUDE_DIRS="$MAGICK_HOME/include" -DImageMagick_LIBRARIES="$MAGICK_HOME/lib" -DImageMagick_Magick++_LIBRARIES="$MAGICK_HOME/lib" -DImageMagick_MagickWand_LIBRARIES="$MAGICK_HOME/lib" -DImageMagick_MagickCore_LIBRARIES="$MAGICK_HOME/lib"
